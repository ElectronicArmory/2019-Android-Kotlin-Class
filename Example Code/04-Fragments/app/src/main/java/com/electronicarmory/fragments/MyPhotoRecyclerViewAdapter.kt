...
import com.electronicarmory.fragments.PhotoFragment.OnListFragmentInteractionListener
import com.electronicarmory.fragments.dummy.PhotoContent.PhotoItem

import kotlinx.android.synthetic.main.fragment_photo.view.*

/**
 * [RecyclerView.Adapter] that can display a [PhotoItem] and makes a call to the
 * specified [OnListFragmentInteractionListener].
 * TODO: Replace the implementation with code for your data type.
 */
class MyPhotoRecyclerViewAdapter(
    private val mValues: List<PhotoItem>,
